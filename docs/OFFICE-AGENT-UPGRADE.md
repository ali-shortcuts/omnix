...
After a verified replacement is published with installer, source and provenance assets, the release workflow removes only superseded previews 62 and 63 and their tags. User branches and repository history are retained. This cleanup is scoped explicitly and does not delete arbitrary future releases.
