...
namespace OMNIX.Core.Tools
{
    internal static class PowerPointAdvancedCapabilities
    {
        ...
        private static void AnimationAdd(Ppt.Presentation p,ToolArguments a){var s=Slide(p,a);var sh=Shape(p,a);string type=a.Get("type","appear").ToLowerInvariant();Ppt.MsoAnimEffect e=type=="fade"?Ppt.MsoAnimEffect.msoAnimEffectFade:type=="fly"?Ppt.MsoAnimEffect.msoAnimEffectFly:Ppt.MsoAnimEffect.msoAnimEffectAppear;s.TimeLine.MainSequence.AddEffect(sh,e,Ppt.MsoAnimateByLevel.msoAnimateLevelNone,Ppt.MsoAnimTriggerType.msoAnimTriggerOnPageClick);}
